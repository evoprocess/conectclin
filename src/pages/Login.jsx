...
const Login = () => {
  ...
  const [tempData, setTempData] = useState(null); // dados temporários para criar senha
  ...
  const handleLogin = async (e) => {
    ...
    if (result && !result.email) {
      // Primeiro acesso: guardar dados temporários
      setTempData(result);
  ...
  return (
    <div className="login-wrapper">
        ...
        <div className="login-card">
          ...
          <form id="loginForm" className="login-form" onSubmit={handleLogin}>
            ...
            <div className="input-group-custom">
              ...
              <div className="input-icon password-toggle" onClick={() => setShowPassword(!showPassword)}>
      ...
      {/* Tela de criar senha no primeiro acesso */}
      {tela === 'createPassword' && tempData && (
        <div className="login-card">
          <div className="login-header">
            <div className="logo-container">
              <img src={logoImage} alt="TratamentoWeb" className="login-logo-img" />
          ...
          <form id="createPasswordForm" className="login-form" onSubmit={handleCreatePassword}>
            <div className="info-box" style={{ background: '#e8eaf6', padding: '12px', borderRadius: '12px', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '10px' }}>
              <i className="bi bi-info-circle" style={{ color: '#1a237e' }}></i>
              <span style={{ fontSize: '13px', color: '#1a237e' }}>Crie uma senha forte e segura para suas próximas visitas.</span>
            </div>
            ...
            <div className="input-group-custom">
              ...
              <div className="input-icon password-toggle" onClick={() => setShowNewPassword(!showNewPassword)}>
            ...
            <div className="input-group-custom">
              ...
              <div className="input-icon password-toggle" onClick={() => setShowConfirmPassword(!showConfirmPassword)}>
