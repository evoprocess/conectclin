        ...
        <div className={styles.mainContent}>
          <div className={styles.header}>
            ...
            <p className={styles.subtitle}>
              Formulário exclusivo para funcionários (Profissionais e Recepcionistas = Perfil Supervisor) e gestores (DANI = Perfil Gerente) cadastrarem novos pacientes na plataforma.
            </p>
          </div>
